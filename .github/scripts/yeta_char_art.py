...
CHARS = [
    ...
    ("sera",  "a fierce beautiful woman, the youngest 'awakener' — unmistakably a grown woman with soft feminine features, chic aloof guarded expression with loneliness underneath, sleek high ponytail with one earphone in, faint incandescent power-lines glowing along one arm from climbing 'the Tower', a sporty crop-and-jacket practice outfit; a hot-pink (#ff8fb3) awakened aura crackling faintly, a vast shadowy spire looming in the deep background."),
    ("haeun", "an elegant playful woman dancer touched by quiet word-magic, a warm teasing smile, soft wavy shoulder-length hair, refined features, a stylish blouse with a canvas dance bag, faint glowing hangul letters and golden ink drifting off an open book beside her like fireflies; a soft gold (#ffd36b) aura, dusk practice-room glow behind."),
