...
FACES = [
    ...
    ("sera",  "a beautiful alluring grown woman, an idol trainee with a magnetic attention-drawing charm and a confident flirtatious edge, chic aloof guarded expression with a flicker of loneliness underneath, sleek high ponytail, delicate sharp attractive features, a trendy stylish stage-ready outfit; dreamy underground practice-room neon pink-and-blue haze, cool fluorescent shimmer."),
    ("haeun", "a beautiful elegant grown woman, a dancer with a way with words, a warm teasing playful smile, soft wavy shoulder-length hair, graceful refined features, a neat stylish blouse, a teacup by a window; soft dusk window glow with drifting warm petals of light."),
