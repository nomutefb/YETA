...
CHARS = {
    "mudi":  "calm tea master in a dark apron, carrying a small wooden tea tray with a steaming cup, gentle smile, soft mint-green color accents, unhurried walk",
    "sera":  "sulky woman in an oversized hoodie and training pants, one earphone in, messy short hair, hands in pockets, pink color accents, slouchy walk",
    "haeun": "cheerful woman in a cardigan, swinging a tote bag, playful grin, warm yellow color accents, bouncy walk",
    ...
    "winter": "graceful woman idol in casual off-stage wear, short neat hair, calm cool expression with a faint warm smile, ice-blue color accents, poised light walk",   # 아이돌 윈터(카드) — 동상
